package com.smy3infotech.divyaangdishaa.Activitys.Categorys
...
import com.smy3infotech.divyaangdishaa.Activitys.DashBoardActivity
import com.smy3infotech.divyaangdishaa.AdaptersAndModels.AddPostResponse
import com.smy3infotech.divyaangdishaa.AdaptersAndModels.CatListAdapter
...
class EditPostActivity : AppCompatActivity() {
    ...
    private fun categoriesDataSet(categorysList: List<CategoriesModel>) {
        ...
        // Find the position of the item with the matching categoryId
        val selectedPosition = categorysList.indexOfFirst { it.category_id == categoriesId }

        // Set the selection to the found position (if valid)
        ...
        binding.spinnerCategory.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                subCategoriesApi(selectedCategory.category_id) // Load subcategories based on selected category ID
            }
