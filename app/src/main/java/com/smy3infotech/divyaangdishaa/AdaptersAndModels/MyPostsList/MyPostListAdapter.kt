package com.smy3infotech.divyaangdishaa.AdaptersAndModels.MyPostsList
...
class MyPostListAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (item.status.equals("1")){
            ...
            holder.txtActiveStatus.setTextColor(ContextCompat.getColor(holder.itemView.context, R.color.pending))
        }
