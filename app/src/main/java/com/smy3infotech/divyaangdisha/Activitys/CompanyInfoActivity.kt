...
class CompanyInfoActivity : AppCompatActivity() {
    ...
    private fun inits() {
        binding.root.findViewById<TextView>(R.id.txtTitle).text = this@CompanyInfoActivity.getString(R.string.CompanyInfo)
    ...
    private fun companyInfoApi() {
        ViewController.showLoading(this@CompanyInfoActivity)
